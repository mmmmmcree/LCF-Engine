...
uniform DirectionalLight directional_light[3];
...
void main() {
    ...
    float metallic = texture(material.metallic_map, fs_in.uv).b;
    float roughness = texture(material.roughness_map, fs_in.uv).g;
